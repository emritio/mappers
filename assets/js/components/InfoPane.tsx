...
export interface InfoPaneProps {
  ...
  bestRssi: number;
  snr: number;
  onCloseHexPaneClick: React.MouseEventHandler;
}
...
function InfoPane(props: InfoPaneProps) {
  ...
  function recentTime() {
    ...
    let distTimeFull = formatDistanceToNowStrict(
      parseISO(sortedTimes[0].timestamp),
    );
    ...
    let distTimeUnitUppercase =
      distTimeUnit.charAt(0).toUpperCase() + distTimeUnit.slice(1);
  ...
  return (
    <div className="info-pane">
      <div
        className={classNames('pane-nav', {
          'has-subcontent': showLegendPane || props.showHexPane,
        })}
      >
        <svg
          className="mappers-logo"
        ...
        <ul className="nav-links">
          ...
          <li className="nav-link">
            <a
              href="https://docs.helium.com/use-the-network/coverage-mapping"
              target="_blank"
            >
              Docs
            </a>
          ...
          <li className="nav-link">
            <a href="https://github.com/helium/mappers" target="_blank">
              GitHub
            </a>
          </li>
        </ul>
        ...
        <div className="legend">
          <div className="legend-line">
            ...
            <div className="legend-item">
              <svg
                className="legend-icon legend-dBm-low"
                width="14"
                height="14"
                viewBox="0 0 14 14"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span>
                -120<span className="stat-unit"> dBm</span>
              </span>
            </div>
            <div className="legend-item">
              <svg
                className="legend-icon legend-dBm-medium"
                width="14"
                height="14"
                viewBox="0 0 14 14"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span>
                -100<span className="stat-unit"> dBm</span>
              </span>
            </div>
            <div className="legend-item">
              <svg
                className="legend-icon legend-dBm-high"
                width="14"
                height="14"
                viewBox="0 0 14 14"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span>
                -80<span className="stat-unit"> dBm</span>
              </span>
            </div>
          </div>
          ...
          <div className="legend-line">
            <div className="legend-item">
              <svg
                className="legend-icon legend-mapper-witness"
                width="14"
                height="14"
                viewBox="0 0 14 14"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="legend-line">
            <div className="legend-item">
              <svg
                className="legend-icon legend-hotspot"
                width="14"
                height="14"
                viewBox="0 0 14 14"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="main-stats">
          <div className="stats-heading">
            ...
            <button
              ...
              onClick={props.onCloseHexPaneClick}
            >
              <svg
                className="icon"
                width="16"
            ...
            <div className="big-stat">
              ...
              <div className="stat-body">
                ...
                <span className="stat-unit">
                  {' '}
                  {props.uplinks && recentTime().unit} Ago
                </span>
              </div>
            </div>
          </div>
              ...
              <thead className="hotspot-table-head type-smallcap">
                <tr>
                  <th
                    ...
                    title="Helium hotspot that heard the mapping device"
                  >
                    Hotspots
                  </th>
                  <th
                    className="table-right"
                    title="Received Signal Strength Indicator - an estimated measure of power recieved"
                  >
                    RSSI
                  </th>
                  <th className="table-right" title="Signal to noise ratio">
                    SNR
                  </th>
                  <th
                    className="table-right"
                    title="Distance between hotspot and surveyed hex"
                  >
                    Dist
                  </th>
                </tr>
                  ...
                  props.uplinks.map((uplink) => (
                    <tr key={uplink.uplink_heard_id}>
                      <td className="table-left animal-cell">
                        {deKebab(uplink.hotspot_name)}
                      </td>
                      <td className="table-right util-liga-mono tighten table-numeric">
                        {uplink.rssi}
                        <span className="table-unit"> dBm</span>
                      </td>
                      <td className="table-right util-liga-mono tighten table-numeric">
                        {uplink.snr.toFixed(2)}
                      </td>
                      <td className="table-right util-liga-mono tighten table-numeric">
                        {uplinkDistance(uplink.lat, uplink.lng).number}
                        <span className="table-unit">
                          {' '}
                          {uplinkDistance(uplink.lat, uplink.lng).unit}
                        </span>
                      </td>
                    </tr>
                  ))}
