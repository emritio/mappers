...
export interface WelcomeModalProps {
  ...
  onCloseWelcomeModalClick: React.MouseEventHandler;
}
    ...
    <div>
      {props.showWelcomeModal && (
        <div className="modal">
          ...
          <button
            aria-label="Close intro window"
            className="close-button modal-close"
            type="button"
            onClick={props.onCloseWelcomeModalClick}
          >
            <svg
              className="icon"
              width="16"
          ...
          <p className="modal-copy">
            We're getting the conversation started with this release. Your
            feedback is key in defining the features in the next evolution of
            this tool.
          </p>
          <p className="modal-copy">
            Visit{' '}
            ...
            to find a few ways to give input or jump into{' '}
